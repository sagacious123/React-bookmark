    ...
    <footer className="relative bg-primaryblue text-white">
      <div className="container w-10/12 m-auto">
        <div className="sm:w-8/12 lg:w-5/12 py-16 m-auto flex flex-col items-center">
          <h5 className="text-sm tracking-widest">35,000+ ALREADY JOINED</h5>
          <h2 className="text-2xl sm:text-3xl text-center leading-8 sm:leading-10 mt-2 mb-8 md:mt-8 md:mb-9">Stay up-to-date with what we're doing</h2>
